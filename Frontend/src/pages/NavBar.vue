        ...
        <div class="flex justify-center">
          <div class="flex space-x-4">
            <ul class="flex border-b">
              ...
              <li class="mr-1">
                <router-link to="/poolinvite" exact active-class="bg-blue-500 border-l border-t border-r rounded-t" class="bg-white inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold">Pool Invite</router-link>
              </li>
              <li class="-mb-px mr-1">
